...
SPDK_LINK_FLAGS := $(shell PKG_CONFIG_PATH="$(SPDK_PKG_CONFIG_PATH)" pkg-config --libs spdk_env_dpdk spdk_env spdk_event spdk_bdev spdk_thread)
...
export:
    export LD_LIBRARY_PATH=/home/hanshukai/import_libs/spdk/build/lib
